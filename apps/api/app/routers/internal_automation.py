...
/internal/leads/{id}/follow-up-email, and POST /internal/notifications —
the endpoints app.automation.n8n.translator's lead.store/lead.lookup/
lead.follow_up_email/notification.send nodes call back into (see that
module's _internal_callback_node, _lead_lookup_node, and
_lead_follow_up_email_node). Not public: every route depends on
